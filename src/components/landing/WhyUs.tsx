...
const features = [
  {
    title: "Certified Stinging Technicians",
    description: "Our Brooksville team consists of certified specialists with intense structural safety training.",
    icon: Award
  },
  {
    title: "24/7 Rapid Extraction",
    description: "We guarantee an immediate response for all Brooksville wasp emergencies, ensuring family safety.",
    icon: Zap
  },
  {
    title: "Flat-Protocol Pricing",
    description: "Transparent, honest rates for all emergency nest removals. No unexpected dispatch fees.",
    icon: DollarSign
  }
];
      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative text-nowrap">
            ...
            <div className="relative z-10 text-nowrap">
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-12 italic font-medium text-nowrap">
                We've built our reputation on precision, safety, and rapid <br /> elimination. When Brooksville families need help, they call the Pros.
              </p>
          ...
          <div className="relative lg:mt-0 text-nowrap text-nowrap">
            ...
            <img
              src="/1.jpeg"
              alt="Brooksville Emergency Wasp Removal"
              className="relative z-10 w-full h-[600px] object-cover rounded-[3rem] shadow-2xl brightness-90 contrast-110 grayscale-[0.2] hover:grayscale-0 transition-all duration-700 text-nowrap text-nowrap"
            />
            <div className="absolute bottom-12 -left-12 z-20 bg-white p-8 rounded-3xl shadow-2xl border border-slate-100 animate-bounce-slow text-nowrap">
              <div className="flex items-center gap-4 text-nowrap text-nowrap">
                ...
                <div className="text-nowrap text-nowrap">
                  ...
                  <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest text-nowrap">Safety Guarantee</p>
                </div>
              </div>
            </div>
          </div>
