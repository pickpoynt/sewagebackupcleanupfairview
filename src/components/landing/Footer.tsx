      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <span className="font-heading font-bold text-xl block leading-none tracking-tight text-white uppercase text-[15px]">Beaverton</span>
                <span className="text-sm font-medium text-indigo-500 uppercase tracking-widest text-[10px]">Water Heater Pros</span>
              </div>
            </div>
            <p className="text-slate-400 mb-8 leading-relaxed font-medium italic text-sm text-nowrap">
              Beaverton's specialized team for professional <br /> water heater repair, replacement, and<br /> maintenance across Washington County.
            </p>
          ...
          <div>
            <h4 className="text-lg font-bold mb-8 uppercase tracking-widest text-indigo-400">Water Heater Services</h4>
            <ul className="space-y-4">
              {[
                "Water Heater Repair",
                "Water Heater Replacement",
                "Tankless Water Heater Service",
                "Annual Maintenance & Flush",
          ...
          <div>
            <h4 className="text-lg font-bold mb-8 uppercase tracking-widest text-indigo-400">Beaverton NAP</h4>
            <ul className="space-y-6">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-slate-300 uppercase tracking-tight leading-tight">Beaverton, OR 97005</p>
                </div>
              </li>
              <li className="flex gap-4">
                <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6 italic font-medium">
              We specialize in the full range of Beaverton water heater repair and replacement services, utilizing professional-grade diagnostic tools and Oregon-compliant installation protocols.
            </p>
            <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
              <p className="text-[10px] font-bold text-indigo-400 uppercase tracking-[0.2em] mb-2">Service Promise</p>
              <p className="text-sm font-bold text-slate-300 uppercase leading-tight italic">Expert Water Heater Repair Available Across Beaverton, OR.</p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 uppercase tracking-widest text-[10px] font-bold">
          <p className="text-slate-500 text-center md:text-left">
            © {new Date().getFullYear()} Beaverton Water Heater Repair Pros. All rights reserved. Professional Water Heater Repair & Replacement in Beaverton, OR.
          </p>
